...
const SongDetails = () => {
    ...
    const song=data.filter(data=>data?.artists?.[0].adamid===songid );
    console.log(song)
  
return(
    <>
<div className="flex flex-col">
<DetailsHeader artistId={songid} songData={song} />
<div className="mb-10 ">
    <h2 className="text-white text-3xl font-bold">Lyrics</h2>
    <div className="mt-5">
     <p className="text-white text-xl">Sorry no Lyrics  Found</p>
